            ...
            <div>
              ...
              <div style={buttonContainerStyle}>
                ...
                <button
                  ...
                  onMouseOver={(e) => !(!bmi || loading) && (e.target.style.backgroundColor = '#059669')}
                  onMouseOut={(e) => !(!bmi || loading) && (e.target.style.backgroundColor = '#10b981')}
                >
                  {loading ? 'Saving...' : 'Save'}
                </button>
                <button
                  ...
                  {bmiHistory.map((record) => {
                    ...
                    return (
                      <div 
                        ...
                        onMouseOver={(e) => e.target.style.boxShadow = '0 4px 12px -2px rgba(0, 0, 0, 0.1)'}
